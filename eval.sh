...
CUDA_VISIBLE_DEVICES=2,3 python experiments/libero/run_libero_manager.py \
    task=dream_fastwam_libero_goal \
    MULTIRUN.task_suite_names="[libero_goal]"  MULTIRUN.num_gpus=2 MULTIRUN.max_tasks_per_gpu=3 \
    ckpt=runs/dream_fastwam_libero_goal/2026-06-26_13-19-05_5030/checkpoints/weights/step_003308.pt
